-- Rollback de 20260906023101_guardar_encuesta_completa_idempotencia.sql
-- Restaura el body de 20260906022901_guardar_encuesta_completa_iniciada_en.sql
-- (sin p_idempotency_key ni el chequeo de idempotencia).
