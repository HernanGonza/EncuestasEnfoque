-- Rollback de 20260912151000_encuestas_online_tema.sql
...
alter table public.encuestas drop constraint if exists encuestas_tema_visual_check;
alter table public.encuestas drop column if exists tema_visual;
alter table public.encuestas drop column if exists titulo_publico;
alter table public.encuestas drop column if exists subtitulo_publico;
