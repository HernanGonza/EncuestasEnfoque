-- Rollback de 20260907150000_get_respuestas_crudas_zona_denormalizada.sql
-- Restaura el body vigente antes de este cambio (vía asignaciones_encuesta,
-- ver 20260906023300_get_respuestas_crudas_zona.sql) — OJO: esa versión es
-- la que dropeaba ~27% de las sesiones completadas por asignacion_id
